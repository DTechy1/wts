<template>
  <MainLayout>
    ...
    <section class="relative h-[70vh] min-h-[520px] overflow-hidden">
      <img :src="getImageUrl('images/couple safari/lidia-stawinska-Oc4u_mYkimk-unsplash.jpg')"
           alt="5 Days Couple Experience Zanzibar" class="w-full h-full object-cover ken-burns" />
      ...
      <div class="absolute inset-0 flex items-end pb-16 px-4 md:px-8 lg:px-12">
        <div class="container mx-auto max-w-7xl">
          <div class="inline-flex items-center gap-2 bg-safari-orange text-white px-4 py-2 rounded-full text-sm font-semibold mb-5">
            ...
            Romantic Zanzibar Adventure
          </div>
          <h1 class="text-5xl md:text-7xl font-heading font-bold text-white mb-4 leading-tight">5 Days Couple Experience Zanzibar</h1>
          <p class="text-xl md:text-2xl text-white/90 max-w-2xl mb-8">Prison Island · Mnemba Island · Safari Blue · Sunset Cruises</p>
    ...
    <section class="py-20 px-4 md:px-8 lg:px-12 bg-gradient-to-br from-safari-brown/5 to-safari-orange/5">
      <div class="container mx-auto max-w-7xl">
        <div class="text-center mb-14">
          ...
          <h2 class="text-4xl md:text-5xl font-heading font-bold text-safari-brown mb-4">Romantic Zanzibar</h2>
          <p class="text-gray-600 max-w-2xl mx-auto">Discover the romantic beauty of Zanzibar through our curated collection of stunning couple experiences</p>
        </div>
              ...
              <div :class="[
                ...
                <div class="group bg-safari-white rounded-2xl shadow-lg hover:shadow-xl transition-all duration-300 overflow-hidden border border-gray-100 hover:border-safari-orange/30">
                  <div class="p-6 md:p-8">
                    ...
                    <ul class="space-y-2">
                      <li v-for="(activity, i) in day.activities" :key="i" class="flex items-start gap-3">
    ...
    <section class="py-20 px-4 md:px-8 lg:px-12 bg-gradient-to-br from-safari-orange to-safari-orange/80">
      <div class="container mx-auto max-w-4xl">
        <div class="bg-white rounded-3xl shadow-2xl p-10 md:p-14 text-center">
          <h2 class="text-3xl md:text-4xl font-heading font-bold text-safari-brown mb-4">Ready for Your Romantic Zanzibar Adventure?</h2>
          <p class="text-gray-600 text-lg mb-8 max-w-xl mx-auto">Experience the perfect romantic getaway with dolphins, sunset cruises, and pristine beaches</p>
          <div class="flex flex-col sm:flex-row gap-4 justify-center">
            ...
            <a href="https://wa.me/255686526171" target="_blank"
              ...
              <svg class="w-6 h-6" fill="currentColor" viewBox="0 0 24 24">
                <path d="M17.472 14.382c-.297-.149-1.758-.867-2.03-.967-.273-.099-.471-.148-.67.15-.197.297-.767.966-.94 1.164-.173.199-.347.223-.644.075-.297-.15-1.255-.463-2.39-1.475-.883-.788-1.48-1.761-1.653-2.059-.173-.297-.018-.458.13-.606.134-.133.298-.347.446-.52.149-.174.198-.298.298-.497.099-.198.05-.371-.025-.52-.075-.149-.669-1.612-.916-2.207-.242-.579-.487-.5-.669-.51-.173-.008-.371-.01-.57-.01-.198 0-.52.074-.792.372-.272.297-1.04 1.016-1.04 2.479 0 1.462 1.065 2.875 1.213 3.074.149.198 2.096 3.2 5.077 4.487.709.306 1.262.489 1.694.625.712.227 1.36.195 1.871.118.571-.085 1.758-.719 2.006-1.413.248-.694.248-1.289.173-1.413-.074-.124-.272-.198-.57-.347m-5.421 7.403h-.004a9.87 9.87 0 01-5.031-1.378l-.361-.214-3.741.982.998-3.648-.235-.374a9.86 9.86 0 01-1.51-5.26c.001-5.45 4.436-9.884 9.888-9.884 2.64 0 5.122 1.03 6.988 2.898a9.825 9.825 1 0 012.893 6.994c-.003 5.45-4.437 9.884-9.885 9.884m8.413-18.297A11.815 11.815 0 0012.05 0C5.495 0 .16 5.335.157 11.892c0 2.096.547 4.142 1.588 5.945L.057 24l6.305-1.654a11.882 11.882 0 005.683 1.448h.005c6.554 0 11.89-5.335 11.893-11.893a11.821 11.821 0 00-3.48-8.413Z"/>
              </svg>
              Chat with Walter
            </a>
          </div>
...
const heroBadges = ['5 Days / 4 Nights', 'Romantic', 'Private Tour'];

const quickStats = [
  { value: '5', label: 'Days' },
  { value: '4', label: 'Activities' },
  { value: 'Sunset', label: 'Cruises' },
  { value: 'Private', label: 'Guide' },
];

const routeStops = ['Prison Island', 'Mnemba Island', 'Safari Blue', 'Departure'];

const galleryImages = [
  { src: 'images/couple safari/lidia-stawinska-Oc4u_mYkimk-unsplash.jpg', alt: 'Romantic Beach Sunset' },
  { src: 'images/couple safari/alferio-njau-jcxtiCYGNpQ-unsplash.jpg', alt: 'Couple Safari Adventure' },
  { src: 'images/couple safari/moses-londo-ZLhi6-ntdU4-unsplash.jpg', alt: 'Zanzibar Paradise' },
  { src: 'images/couple safari/rafal-jedrzejek-gWnopYBOsJU-unsplash.jpg', alt: 'Tropical Romance' },
];

const itinerary = [
  {
    day: 1,
    title: 'Transfer from Zanzibar Airport to your Booked Hotel',
  ...
  {
    day: 2,
    title: 'Prison Island & Nakupenda Island',
  ...
  {
    day: 3,
    title: 'Mnemba Island, Dolphins Tour & Dhow Sunset Cruise',
  ...
  },
  {
    ...
    activities: [
      ...
      'Snorkeling in Menai Bay',
      'Seafood BBQ lunch'
    ]
  },
  {
    day: 5,
    title: 'Transfer from your Booked Hotel to Zanzibar Airport',
    location: 'Departure',
    activities: [
...
const priceIncludes = [
  ...
  { label: 'Fruits', icon: 'M12 8v13m0-13V6a2 2 0 112 2h-2zm0 0V5.5A2.5 2.5 0 109.5 8H12zm-7 4h14M5 12a2 2 0 110-4h14a2 2 0 110 4M5 12v7a2 2 0 002 2h10a2 2 0 002-2v-7' },
  ...
  { label: 'Car', icon: 'M8 7h12m0 0l-4-4m4 4l-4 4m0 6H4m0 0l4 4m-4-4l4-4' },
  { label: 'Local Boat', icon: 'M8 7h12m0 0l-4-4m4 4l-4 4m0 6H4m0 0l4 4m-4-4l4-4' },
  { label: 'Government Fees (VAT)', icon: 'M9 14l6-6m-5.5.5h.01m4.99 5h.01M19 21V5a2 2 0 00-2-2H7a2 2 0 00-2 2v16l3.5-2 3.5 2 3.5-2 3.5 2z' },
  { label: 'Entrance fees (Facilities Cost)', icon: 'M9 12l2 2 4-4m5.618-4.016A11.955 11.955 0 0112 2.944a11.955 11.955 0 01-8.618 3.04A12.02 12.02 0 003 9c0 5.591 3.824 10.29 9 11.622 5.176-1.332 9-6.03 9-11.622 0-1.042-.133-2.052-.382-3.016z' },
];
</script>
