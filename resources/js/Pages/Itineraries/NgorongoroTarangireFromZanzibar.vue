<template>
  <MainLayout>
    ...
    <section class="relative h-[70vh] min-h-[520px] overflow-hidden">
      <img :src="getImageUrl('images/ngorongoro/pexels-alexandra-karnasopoulos-1962842-7205279.jpg')"
           alt="2 Days Big 5 Safari from Zanzibar" class="w-full h-full object-cover ken-burns" />
      ...
      <div class="absolute inset-0 flex items-end pb-16 px-4 md:px-8 lg:px-12">
        <div class="container mx-auto max-w-7xl">
          ...
          <h1 class="text-5xl md:text-7xl font-heading font-bold text-white mb-4 leading-tight">Big 5 Safari from Zanzibar</h1>
          <p class="text-xl md:text-2xl text-white/90 max-w-2xl mb-8">Ngorongoro Crater · Tarangire National Park</p>
    ...
    <section class="py-16 px-4 md:px-8 lg:px-12 bg-safari-white">
      <div class="container mx-auto max-w-7xl">
        <div class="text-center mb-10">
          ...
          <h2 class="text-3xl md:text-4xl font-heading font-bold text-safari-brown">Beach to Bush Adventure</h2>
        </div>
    ...
    <section class="py-20 px-4 md:px-8 lg:px-12 bg-gradient-to-br from-safari-brown/5 to-safari-orange/5">
      <div class="container mx-auto max-w-7xl">
        <div class="text-center mb-14">
          ...
          <h2 class="text-4xl md:text-5xl font-heading font-bold text-safari-brown mb-4">Big 5 Safari</h2>
          <p class="text-gray-600 max-w-2xl mx-auto">Experience the best of Tanzania's wildlife through stunning imagery from Tarangire and Ngorongoro</p>
        </div>
    ...
    <section class="py-20 px-4 md:px-8 lg:px-12 bg-gradient-to-br from-safari-orange to-safari-orange/80">
      <div class="container mx-auto max-w-4xl">
        <div class="bg-white rounded-3xl shadow-2xl p-10 md:p-14 text-center">
          <h2 class="text-3xl md:text-4xl font-heading font-bold text-safari-brown mb-4">Book Your Big 5 Safari from Zanzibar</h2>
          <p class="text-gray-600 text-lg mb-8 max-w-xl mx-auto">Perfect 2-day safari combining beach relaxation with wildlife adventure</p>
...
const heroBadges = ['2 Days / 1 Night', 'Big 5 Safari', 'Flights Included', 'From Zanzibar'];

const quickStats = [
  { value: '2', label: 'Days' },
  { value: 'Big 5', label: 'Wildlife' },
  { value: 'Flights', label: 'Included' },
  { value: 'Private', label: '4x4 Vehicle' },
];

const routeStops = ['Zanzibar', 'Flight to Arusha', 'Tarangire', 'Karatu Lodge', 'Ngorongoro', 'Return Flight'];
...
const galleryImages = [
  ...
  { src: 'images/tarangire/pexels-gsn-travel-28359728.jpg', alt: 'Baobab Trees' },
  { src: 'images/ngorongoro/pexels-sam-hofman-817359426-20024158.jpg', alt: 'Savanna Landscape' },
];

const itinerary = [
  {
    day: 1,
    title: 'TARANGIRE NATIONAL PARK FULL DAY',
    location: 'Tarangire',
    description: 'Early morning from Zanzibar > transfer to airport to fly Arusha and pick up with our guide from walters team, and drive to enter the Tarangire National Park. Tarangire National Park is known for its majestic baobab trees that dot the landscape, dwarfing the animals that feed beneath them. The Tarangire River is the centerpiece of this park which is famous for some of the largest herds of elephants in Africa. Here you may see lion, leopard, cheetah, lesser kudu, buffalo, Oryx, eland, giraffe and zebra. We will have a lunch break at a scenic picnic spot. Post lunch, we will continue with game drives on later check out the park and drive up to Ngorongoro Karatu area lodge for overnight.',
    image: 'images/tarangire/pexels-bgbennett-19986844.jpg',
  },
  {
    day: 2,
    title: 'NGORONGORO CRATER & AIRPORT',
    location: 'Ngorongoro Crater',
    description: 'Morning around 7:30 AM from your lodge pick up and drive to Ngorongoro with hot packed lunch boxes. Once we reach the park, we descend to the crater floor for a game drive (6-7 hours). You can expect to see lions, elephants, zebras, hippos, hyenas, Jackals, rhinos and many birds. The birds seen here include eagles, vultures, flamingos in the Crater Lake, storks, giant vultures, and many more. We will have a lunch break at the beautiful Hippo pool. Post lunch, we will continue with game drives and later evening drive check out the park and drive back to Arusha city for a flight.',
    image: 'images/ngorongoro/pexels-lan-yao-324969-20847561.jpg',
  },
];

const priceIncludes = [
  { label: 'Flight tickets', icon: 'M12 19l9 2-9-18-9 18 9-2zm0 0v-8' },
  { label: 'All park entrance fees', icon: 'M9 12l2 2 4-4m5.618-4.016A11.955 11.955 0 0112 2.944a11.955 11.955 0 01-8.618 3.04A12.02 12.02 0 003 9c0 5.591 3.824 10.29 9 11.622 5.176-1.332 9-6.03 9-11.622 0-1.042-.133-2.052-.382-3.016z' },
  { label: 'Safari car 4x4 Private', icon: 'M8 7h12m0 0l-4-4m4 4l-4 4m0 6H4m0 0l4 4m-4-4l4-4' },
  { label: 'Professional guide', icon: 'M16 7a4 4 0 11-8 0 4 4 0 018 0zM12 14a7 7 0 00-7 7h14a7 7 0 00-7-7z' },
  { label: 'Accommodation lodge', icon: 'M3 12l2-2m0 0l7-7 7 7M5 10v10a1 1 0 001 1h3m10-11l2 2m-2-2v10a1 1 0 01-1 1h-3m-6 0a1 1 0 001-1v-4a1 1 0 011-1h2a1 1 0 011 1v4a1 1 0 001 1m-6 0h6' },
  { label: 'Meals soft drinks', icon: 'M12 8v13m0-13V6a2 2 0 112 2h-2zm0 0V5.5A2.5 2.5 0 109.5 8H12zm-7 4h14M5 12a2 2 0 110-4h14a2 2 0 110 4M5 12v7a2 2 0 002 2h10a2 2 0 002-2v-7' },
  { label: 'Pick up drop off', icon: 'M17 20h5v-2a3 3 0 00-5.356-1.857M17 20H7m10 0v-2c0-.656-.126-1.283-.356-1.857M7 20H2v-2a3 3 0 015.356-1.857M7 20v-2c0-.656.126-1.283.356-1.857m0 0a5.002 5.002 0 019.288 0M15 7a3 3 0 11-6 0 3 3 0 016 0zm6 3a2 2 0 11-4 0 2 2 0 014 0zM7 10a2 2 0 11-4 0 2 2 0 014 0z' },
