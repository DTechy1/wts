<template>
  <MainLayout>
    ...
    <section class="relative h-[70vh] min-h-[520px] overflow-hidden">
      <img :src="getImageUrl('images/tarangire/pexels-bgbennett-19986844.jpg')"
           alt="1 Day Tarangire Safari" class="w-full h-full object-cover ken-burns" />
      ...
      <div class="absolute inset-0 flex items-end pb-16 px-4 md:px-8 lg:px-12">
        <div class="container mx-auto max-w-7xl">
          ...
          <h1 class="text-5xl md:text-7xl font-heading font-bold text-white mb-4 leading-tight">1 Day Tarangire Safari</h1>
          <p class="text-xl md:text-2xl text-white/90 max-w-2xl mb-8">Elephant Paradise · Baobab Trees · Game Drives</p>
    ...
    <section class="py-20 px-4 md:px-8 lg:px-12 bg-gradient-to-br from-safari-brown/5 to-safari-orange/5">
      <div class="container mx-auto max-w-7xl">
        <div class="text-center mb-14">
          ...
          <h2 class="text-4xl md:text-5xl font-heading font-bold text-safari-brown mb-4">Tarangire National Park</h2>
          <p class="text-gray-600 max-w-2xl mx-auto">Discover the elephant paradise with giant baobab trees through stunning imagery</p>
        </div>
    ...
    <section class="py-20 px-4 md:px-8 lg:px-12 bg-white">
      <div class="container mx-auto max-w-7xl">
        <div class="text-center mb-16">
          ...
          <h2 class="text-4xl md:text-5xl font-heading font-bold text-safari-brown">Safari Schedule</h2>
        </div>
        ...
        <div class="relative">
          ...
          <div class="space-y-12 lg:space-y-0">
            <div v-for="(schedule, index) in daySchedule" :key="index"
                ...
                <div class="group bg-safari-white rounded-2xl shadow-lg hover:shadow-xl transition-all duration-300 overflow-hidden border border-gray-100 hover:border-safari-orange/30">
                  <div class="p-6 md:p-8">
                    <div class="flex items-start gap-3 mb-3">
                      ...
                      <div>
                        <span class="inline-block text-xs font-semibold uppercase tracking-wider text-safari-orange mb-1">{{ schedule.location }}</span>
                        <h3 class="text-xl md:text-2xl font-heading font-bold text-safari-brown">{{ schedule.time }}</h3>
                      </div>
                    </div>
    ...
    <section class="py-20 px-4 md:px-8 lg:px-12 bg-gradient-to-br from-safari-orange to-safari-orange/80">
      <div class="container mx-auto max-w-4xl">
        <div class="bg-white rounded-3xl shadow-2xl p-10 md:p-14 text-center">
          <h2 class="text-3xl md:text-4xl font-heading font-bold text-safari-brown mb-4">Ready for Your Tarangire Safari?</h2>
          <p class="text-gray-600 text-lg mb-8 max-w-xl mx-auto">Experience the elephant paradise with giant baobab trees and incredible wildlife</p>
...
const heroBadges = ['1 Day', 'Day Trip', 'Private Safari'];

const quickStats = [
  { value: '1', label: 'Day' },
  { value: 'Full', label: 'Day Safari' },
  { value: 'Elephants', label: 'Paradise' },
  { value: 'Private', label: '4x4' },
];

const routeStops = ['Arusha', 'Tarangire Park', 'Game Drives', 'Return'];
...
const galleryImages = [
  ...
  { src: 'images/tarangire/pexels-kureng-workx-2546437-13242021.jpg', alt: 'Safari Adventure' },
  { src: 'images/tarangire/pexels-tanzania-wild-sky-986912744-20179671.jpg', alt: 'Wildlife Safari' },
];
...
const daySchedule = [
  {
    time: '08:00 AM',
    location: 'Arusha',
    description: 'Pick-up from Arusha in a 4x4 safari vehicle.'
  },
  {
    time: '10:00 AM',
    location: 'Tarangire Park',
    description: 'Arrive at Tarangire National Park, famous for its giant baobab trees and large elephant herds.'
  },
  {
    time: 'Morning Game Drive',
    location: 'Tarangire Park',
    description: 'Spot wildlife such as lions, giraffes, zebras, wildebeest, and over 500 bird species and Big elephants.'
  },
  {
    time: '01:30 PM',
    location: 'Tarangire Park',
    description: 'Enjoy a picnic lunch at a scenic spot inside the park.'
  },
  {
    time: 'Afternoon Game Drive',
    location: 'Tarangire River',
    description: 'Explore the Tarangire River area, known for its high concentration of wildlife during the dry season.'
  },
  {
    time: '04:00 PM',
    location: 'Tarangire Park',
    description: 'Depart the park and begin the return journey to Arusha.'
  },
  {
    time: '06:30 PM',
    location: 'Arusha',
    description: 'Drop-off Arusha.'
  }
];
...
const priceIncludes = [
  ...
  { label: '4x4 safari vehicle land cruiser pop-up roof', icon: 'M8 7h12m0 0l-4-4m4 4l-4 4m0 6H4m0 0l4 4m-4-4l4-4' },
  { label: 'Picnic lunch and soft drinks', icon: 'M12 8v13m0-13V6a2 2 0 112 2h-2zm0 0V5.5A2.5 2.5 0 109.5 8H12zm-7 4h14M5 12a2 2 0 110-4h14a2 2 0 110 4M5 12v7a2 2 0 002 2h10a2 2 0 002-2v-7' },
];
</script>
