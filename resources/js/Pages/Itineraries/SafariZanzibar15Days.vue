<template>
  <MainLayout>
    ...
    <section class="relative h-[70vh] min-h-[520px] overflow-hidden">
      <img :src="getImageUrl('images/walters-tours-safaris-sammy-wong-wzeGc7Uqopc-unsplash.jpg')"
           alt="15 Day Safari and Zanzibar" class="w-full h-full object-cover ken-burns" />
      ...
      <div class="absolute inset-0 flex items-end pb-16 px-4 md:px-8 lg:px-12">
        <div class="container mx-auto max-w-7xl">
          <div class="inline-flex items-center gap-2 bg-safari-orange text-white px-4 py-2 rounded-full text-sm font-semibold mb-5">
            ...
            Ultimate Tanzania Adventure
          </div>
          <h1 class="text-5xl md:text-7xl font-heading font-bold text-white mb-4 leading-tight">15 Day Safari and Zanzibar</h1>
          <p class="text-xl md:text-2xl text-white/90 max-w-2xl mb-8">Serengeti · Ngorongoro · Zanzibar Beaches</p>
    ...
    <section class="py-16 px-4 md:px-8 lg:px-12 bg-safari-white">
      <div class="container mx-auto max-w-7xl">
        <div class="text-center mb-10">
          ...
          <h2 class="text-3xl md:text-4xl font-heading font-bold text-safari-brown">The Ultimate Route</h2>
        </div>
    ...
    <section class="py-20 px-4 md:px-8 lg:px-12 bg-gradient-to-br from-safari-orange to-safari-orange/80">
      <div class="container mx-auto max-w-4xl">
        <div class="bg-white rounded-3xl shadow-2xl p-10 md:p-14 text-center">
          <h2 class="text-3xl md:text-4xl font-heading font-bold text-safari-brown mb-4">Ready for Your Ultimate Tanzania Experience?</h2>
          <p class="text-gray-600 text-lg mb-8 max-w-xl mx-auto">Experience the Big Five, Great Migration, and pristine Zanzibar beaches</p>
...
const heroBadges = ['15 Days / 14 Nights', 'Safari & Beach', 'Ultimate Experience'];

const quickStats = [
  { value: '15', label: 'Days' },
  { value: 'Big 5', label: 'Safari' },
  { value: 'Beach', label: 'Relax' },
  { value: 'Private', label: 'Guide' },
];

const routeStops = ['Arusha', 'Serengeti', 'Ngorongoro', 'Zanzibar', 'Departure'];
...
const itinerary = [
  {
    ...
    title: 'Arrival',
    location: 'Arusha',
    description: 'Land at Kilimanjaro International Airport (JRO) and transfer to a hotel in Arusha.'
  },
  {
    day: 2,
    title: 'Tarangire National Park',
    location: 'Tarangire',
    description: 'Drive to Tarangire (about 2 hours). Famed for its massive elephant herds and ancient baobab trees.'
  },
  {
    day: 3,
    title: 'Lake Manyara National Park',
    location: 'Lake Manyara',
    description: 'Head to Manyara to see tree-climbing lions and flocks of flamingos.'
  },
  {
    day: 4,
    title: 'Central Serengeti (Day 1)',
    location: 'Serengeti',
    description: 'Drive into the Serengeti National Park. Spend first full day tracking predators and witnessing incredible biodiversity.'
  },
  {
    day: 5,
    title: 'Central Serengeti (Day 2)',
    location: 'Serengeti',
    description: 'Continue exploring Serengeti with full day game drives tracking the Big Five and Great Migration.'
  },
  {
    day: 6,
    title: 'Serengeti to Ngorongoro',
    location: 'Ngorongoro',
    description: 'Enjoy a morning game drive in the Serengeti, then head toward the Ngorongoro Highlands.'
  },
  {
    day: 7,
    title: 'Ngorongoro Crater',
    location: 'Ngorongoro',
    description: 'Descend 600 meters into the crater floor for a full-day game drive with a high chance of spotting the endangered black rhino.'
  },
  {
    day: 8,
    title: 'Fly to Zanzibar',
    location: 'Zanzibar',
    description: 'Drive back to Arusha and take a short regional flight to Zanzibar International Airport (ZNZ) on the islands.'
  },
  {
    day: 9,
    title: 'Matemwe or Nungwi Beaches (Day 1)',
    location: 'Nungwi Beach',
    description: 'Relax on the northern and eastern coasts at renowned spots like Nungwi Beach. Enjoy diving, snorkeling, or lounging.'
  },
  {
    day: 10,
    title: 'Matemwe or Nungwi Beaches (Day 2)',
    location: 'Nungwi Beach',
    description: 'Continue beach relaxation with water activities and exploring the pristine coastline.'
  },
  {
    day: 11,
    title: 'Matemwe or Nungwi Beaches (Day 3)',
    location: 'Nungwi Beach',
    description: 'Final day of beach relaxation on the northern coast with optional excursions.'
  },
  {
    day: 12,
    title: 'Paje or Jambiani (Day 1)',
    location: 'Paje/Jambiani',
    description: 'Move to the southeastern coast to experience a laid-back village vibe, popular for kitesurfing and pristine sandbars.'
  },
  {
    day: 13,
    title: 'Paje or Jambiani (Day 2)',
    location: 'Paje/Jambiani',
    description: 'Explore the southeastern beaches, enjoy kitesurfing, and experience local village life.'
  },
  {
    day: 14,
    title: 'Stone Town',
    location: 'Stone Town',
    description: 'Explore the Stone Town UNESCO World Heritage Site. Take a guided walking tour through its winding alleys, and enjoy a traditional Spice Tour.'
  },
  {
    day: 15,
    title: 'Departure',
    location: 'Departure',
    description: 'Transfer to the airport in Zanzibar for your international departure flight home.'
  }
];

const priceIncludes = [
  { label: 'Airport transfer', icon: 'M12 19l9 2-9-18-9 18 9-2zm0 0v-8' },
  { label: 'Park entrance fee', icon: 'M9 12l2 2 4-4m5.618-4.016A11.955 11.955 0 0112 2.944a11.955 11.955 0 01-8.618 3.04A12.02 12.02 0 003 9c0 5.591 3.824 10.29 9 11.622 5.176-1.332 9-6.03 9-11.622 0-1.042-.133-2.052-.382-3.016z' },
  ...
  { label: 'Professional guides', icon: 'M16 7a4 4 0 11-8 0 4 4 0 018 0zM12 14a7 7 0 00-7 7h14a7 7 0 00-7-7z' },
  { label: 'Transport private', icon: 'M8 7h12m0 0l-4-4m4 4l-4 4m0 6H4m0 0l4 4m-4-4l4-4' },
];
</script>
