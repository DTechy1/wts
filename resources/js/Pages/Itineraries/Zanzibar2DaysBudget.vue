<template>
  <MainLayout>
    ...
    <section class="relative h-[70vh] min-h-[520px] overflow-hidden">
      <img :src="getImageUrl('images/2 days zanzibar/nichika-sakurai-ei3Ah7DNoxs-unsplash.jpg')"
           alt="2 Days Budget Vacation Zanzibar" class="w-full h-full object-cover ken-burns" />
...
n              <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M17.657 16.657L13.414 20.9a1.998 1.998 0 01-2.827 0l-4.244-4.243a8 8 0 1111.314 0z"/>
            </svg>
            Budget Zanzibar Adventure
          </div>
          <h1 class="text-5xl md:text-7xl font-heading font-bold text-white mb-4 leading-tight">2 Days Budget Vacation Zanzibar</h1>
          <p class="text-xl md:text-2xl text-white/90 max-w-2xl mb-8">Stone Town · Prison Island · Mnemba Island · Turtles</p>
    ...
    <section class="py-20 px-4 md:px-8 lg:px-12 bg-gradient-to-br from-safari-brown/5 to-safari-orange/5">
      <div class="container mx-auto max-w-7xl">
        <div class="text-center mb-14">
          ...
          <h2 class="text-4xl md:text-5xl font-heading font-bold text-safari-brown mb-4">Budget Zanzibar</h2>
          <p class="text-gray-600 max-w-2xl mx-auto">Discover the affordable beauty of Zanzibar through our curated collection of stunning images</p>
        </div>
              ...
              <div :class="[
                ...
                <div class="group bg-safari-white rounded-2xl shadow-lg hover:shadow-xl transition-all duration-300 overflow-hidden border border-gray-100 hover:border-safari-orange/30">
                  <div class="p-6 md:p-8">
                    ...
                    <ul class="space-y-2">
                      <li v-for="(item, i) in day.activities" :key="i" class="flex items-start gap-3">
    ...
    <section class="py-20 px-4 md:px-8 lg:px-12 bg-gradient-to-br from-safari-orange to-safari-orange/80">
      <div class="container mx-auto max-w-4xl">
        <div class="bg-white rounded-3xl shadow-2xl p-10 md:p-14 text-center">
          <h2 class="text-3xl md:text-4xl font-heading font-bold text-safari-brown mb-4">Ready for Your 2-Day Zanzibar Adventure?</h2>
          <p class="text-gray-600 text-lg mb-8 max-w-xl mx-auto">Experience the best of Zanzibar with dolphins, tortoises, and Stone Town</p>
...
const heroBadges = ['2 Days / 1 Night', 'Budget Friendly', 'Private Tour'];

const quickStats = [
  { value: '2', label: 'Days' },
  { value: '4', label: 'Activities' },
  { value: 'Dolphins', label: 'Swimming' },
  { value: 'Private', label: 'Guide' },
];

const routeStops = ['Stone Town', 'Prison Island', 'Mnemba Island', 'Departure'];

const galleryImages = [
  { src: 'images/2 days zanzibar/nichika-sakurai-ei3Ah7DNoxs-unsplash.jpg', alt: 'Zanzibar Paradise Beach' },
  { src: 'images/2 days zanzibar/micah-camper-Iiy27D3psG8-unsplash.jpg', alt: 'Crystal Clear Waters' },
  { src: 'images/2 days zanzibar/danai-tsoutreli-gdaHl7mDrpw-unsplash.jpg', alt: 'Tropical Escape' },
  { src: 'images/2 days zanzibar/rowen-smith-NMcvybDrCYY-unsplash.jpg', alt: 'Island Adventure' },
];

const itinerary = [
  {
    day: 1,
    title: 'Stone Town + Nakupenda + Prison Island Private',
    location: 'Stone Town',
    activities: [
      'Explore authentic culture',
      'Historical town',
      'Freddie Mercury',
      'Giant tortoises',
      'Forodhani garden',
      'Swim and relax at sandbank white sand'
    ]
  },
  {
    day: 2,
    title: 'Mnemba Dolphin + Swim With Turtles',
    location: 'Mnemba Island',
    activities: [
      'Swim with dolphins',
      'Snorkeling',
      'Sand bank if it\'s low tide',
      'Swim with turtles'
    ]
  }
];
...
const priceIncludes = [
  { label: 'Transfers go and Returns', icon: 'M8 7h12m0 0l-4-4m4 4l-4 4m0 6H4m0 0l4 4m-4-4l4-4' },
  { label: 'Boat', icon: 'M8 7h12m0 0l-4-4m4 4l-4 4m0 6H4m0 0l4 4m-4-4l4-4' },
  ...
  { label: 'Mineral water', icon: 'M12 8v13m0-13V6a2 2 0 112 2h-2zm0 0V5.5A2.5 2.5 0 109.5 8H12zm-7 4h14M5 12a2 2 0 110-4h14a2 2 0 110 4M5 12v7a2 2 0 002 2h10a2 2 0 002-2v-7' },
  { label: 'Tropical Fruits', icon: 'M12 8v13m0-13V6a2 2 0 112 2h-2zm0 0V5.5A2.5 2.5 0 109.5 8H12zm-7 4h14M5 12a2 2 0 110-4h14a2 2 0 110 4M5 12v7a2 2 0 002 2h10a2 2 0 002-2v-7' },
  { label: 'Hot Lunch seafood food', icon: 'M12 8v13m0-13V6a2 2 0 112 2h-2zm0 0V5.5A2.5 2.5 0 109.5 8H12zm-7 4h14M5 12a2 2 0 110-4h14a2 2 0 110 4M5 12v7a2 2 0 002 2h10a2 2 0 002-2v-7' },
  { label: 'Swimming Equipments', icon: 'M9 14l6-6m-5.5.5h.01m4.99 5h.01M19 21V5a2 2 0 00-2-2H7a2 2 0 00-2 2v16l3.5-2 3.5 2 3.5-2 3.5 2z' },
];
</script>
