  ...
  <MainLayout>
    ...
    <section class="relative h-[70vh] min-h-[520px] overflow-hidden">
      <img :src="getImageUrl('images/serengeti/pexels-bgbennett-20095156.jpg')"
           alt="7 Day Serengeti Safari" class="w-full h-full object-cover ken-burns" />
      ...
      <div class="absolute inset-0 flex items-end pb-16 px-4 md:px-8 lg:px-12">
        <div class="container mx-auto max-w-7xl">
          ...
          <h1 class="text-5xl md:text-7xl font-heading font-bold text-white mb-4 leading-tight">7 Day Serengeti Safari</h1>
          <p class="text-xl md:text-2xl text-white/90 max-w-2xl mb-8">Arusha · Tarangire · Ngorongoro · Serengeti</p>
    ...
    <section class="py-16 px-4 md:px-8 lg:px-12 bg-safari-white">
      <div class="container mx-auto max-w-7xl">
        <div class="text-center mb-10">
          ...
          <h2 class="text-3xl md:text-4xl font-heading font-bold text-safari-brown">The Northern Circuit Route</h2>
        </div>
    ...
    <section class="py-20 px-4 md:px-8 lg:px-12 bg-gradient-to-br from-safari-brown/5 to-safari-orange/5">
      <div class="container mx-auto max-w-7xl">
        <div class="text-center mb-14">
          ...
          <h2 class="text-4xl md:text-5xl font-heading font-bold text-safari-brown mb-4">Serengeti Safari</h2>
          <p class="text-gray-600 max-w-2xl mx-auto">Experience the endless plains and incredible wildlife of the Serengeti through stunning imagery</p>
        </div>
    ...
    <section class="py-20 px-4 md:px-8 lg:px-12 bg-gradient-to-br from-safari-orange to-safari-orange/80">
      <div class="container mx-auto max-w-4xl">
        <div class="bg-white rounded-3xl shadow-2xl p-10 md:p-14 text-center">
          <h2 class="text-3xl md:text-4xl font-heading font-bold text-safari-brown mb-4">Ready for Your 7-Day Serengeti Adventure?</h2>
          <p class="text-gray-600 text-lg mb-8 max-w-xl mx-auto">Experience the ultimate northern circuit safari with the best of Tanzania's wildlife</p>
...
const heroBadges = ['7 Days / 6 Nights', 'Private Safari', 'Big Five'];
...
const routeStops = ['Arusha', 'Tarangire', 'Ngorongoro', 'Serengeti', 'Departure'];
...
const galleryImages = [
  ...
  { src: 'images/serengeti/pexels-vik-joshi-63702791-8150758.jpg', alt: 'Big Cats' },
  { src: 'images/serengeti/pexels-sk-movies-photos-5306496-18609145.jpg', alt: 'Migration View' },
];
...
const itinerary = [
  {
    ...
    location: 'Arusha',
    description: 'Arrive at Kilimanjaro International Airport. Transfer to your hotel in Arusha, the gateway to the northern safari circuit, for a restful evening.',
    image: null,
  },
  {
    day: 2,
    ...
    location: 'Tarangire',
    description: 'Drive to Tarangire National Park (approx. 2 hours). Spend the day spotting large elephant herds and iconic baobab trees.',
  ...
  },
  {
    ...
    description: 'Drive through the scenic highlands to the edge of the Ngorongoro Conservation Area, enjoying cultural insights along the way.',
  ...
  },
  {
    ...
    description: 'Descend into the Ngorongoro Crater, a massive volcanic caldera. Spend the day viewing incredibly dense wildlife populations, including the rare black rhino.',
    image: 'images/ngorongoro/pexels-alexandra-karnasopoulos-1962842-7205279.jpg',
  },
  {
    day: 5,
    ...
    description: 'Travel into the heart of the Serengeti National Park. Begin your afternoon game drive searching for the Big Five.',
  ...
  },
  {
    ...
    description: 'Dedicate a full day to exploring the vast plains. Depending on the season, follow the Great Wildebeest Migration or seek out the park\'s resident lions and leopards.',
  ...
  },
  {
    ...
    location: 'Departure',
    description: 'Enjoy a final morning game drive, then take a short flight or drive back to Arusha to connect with your outbound flight.',
    image: 'images/serengeti/pexels-alex-ning-523843601-33650533.jpg',
  },
];

const priceIncludes = [
  { label: 'Land cruiser 4x4 private', icon: 'M8 7h12m0 0l-4-4m4 4l-4 4m0 6H4m0 0l4 4m-4-4l4-4' },
  ...
  { label: 'Accomodation', icon: 'M3 12l2-2m0 0l7-7 7 7M5 10v10a1 1 0 001 1h3m10-11l2 2m-2-2v10a1 1 0 01-1 1h-3m-6 0a1 1 0 001-1v-4a1 1 0 011-1h2a1 1 0 011 1v4a1 1 0 001 1m-6 0h6' },
