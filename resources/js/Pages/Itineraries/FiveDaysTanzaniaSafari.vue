  ...
  <MainLayout>
    ...
    <section class="relative h-[70vh] min-h-[520px] overflow-hidden">
      <img :src="getImageUrl('images/serengeti/pexels-bgbennett-20095156.jpg')"
           alt="5 Days Tanzania Safari" class="w-full h-full object-cover ken-burns" />
      ...
      <div class="absolute inset-0 flex items-end pb-16 px-4 md:px-8 lg:px-12">
        <div class="container mx-auto max-w-7xl">
          ...
          <h1 class="text-5xl md:text-7xl font-heading font-bold text-white mb-4 leading-tight">5 Days Tanzania Safari</h1>
          <p class="text-xl md:text-2xl text-white/90 max-w-2xl mb-8">Tarangire · Serengeti · Ngorongoro · Lake Manyara</p>
    ...
    <section class="py-16 px-4 md:px-8 lg:px-12 bg-safari-white">
      <div class="container mx-auto max-w-7xl">
        <div class="text-center mb-10">
          ...
          <h2 class="text-3xl md:text-4xl font-heading font-bold text-safari-brown">The Northern Circuit Experience</h2>
        </div>
    ...
    <section class="py-20 px-4 md:px-8 lg:px-12 bg-gradient-to-br from-safari-brown/5 to-safari-orange/5">
      <div class="container mx-auto max-w-7xl">
        <div class="text-center mb-14">
          ...
          <h2 class="text-4xl md:text-5xl font-heading font-bold text-safari-brown mb-4">Northern Circuit Safari</h2>
          <p class="text-gray-600 max-w-2xl mx-auto">Experience the best of Tanzania's wildlife through stunning imagery from Tarangire, Serengeti, and Ngorongoro</p>
        </div>
    ...
    <section class="py-20 px-4 md:px-8 lg:px-12 bg-gradient-to-br from-safari-orange to-safari-orange/80">
      <div class="container mx-auto max-w-4xl">
        <div class="bg-white rounded-3xl shadow-2xl p-10 md:p-14 text-center">
          <h2 class="text-3xl md:text-4xl font-heading font-bold text-safari-brown mb-4">Ready for Your 5-Day Tanzania Adventure?</h2>
          <p class="text-gray-600 text-lg mb-8 max-w-xl mx-auto">Experience the best of Tanzania's wildlife and landscapes in this classic safari</p>
...
const heroBadges = ['5 Days / 4 Nights', 'Private Safari', 'Big Five'];

const quickStats = [
  { value: '5', label: 'Days' },
  { value: '4', label: 'National Parks' },
  { value: 'Big 5', label: 'Wildlife' },
  { value: 'Private', label: '4x4 Vehicle' },
];

const routeStops = ['Arusha', 'Tarangire', 'Serengeti', 'Ngorongoro', 'Lake Manyara', 'Departure'];
...
const itinerary = [
  {
    ...
    location: 'Tarangire - Paradise of the Elephants',
    description: 'Pick up early in the morning at arusha hotel or airport by our experienced driver-guide and begin your journey to Tarangire. Enjoy a game drive through the park, home of elephants, baobab trees, giraffes, lions, gazelles, baboons, and many other species. Lunch will be served inside the park later in the afternoon, game driver continue until evening and heading to your lodge for dinner and overnight stay at Lilac hideaway lodge.',
  ...
  },
  {
    ...
    description: 'Morning after breakfast heading to Serengeti National Park. Upon arrival, enjoy an afternoon game drive in search of the great predators lions, cheetah, and other wildlife that roam the endless plains. Later drive to the lodge for overnight at Robin safari Camp.',
  ...
  },
  {
    ...
    description: 'Spend a full day exploring the Serengeti. Begin with an early morning game drive, often the best time to witness big cats and other wildlife in action. After lunch, continue your adventure across the park before returning to your camp for dinner and overnight at Robin safari Camp.',
  ...
  },
  {
    ...
    location: 'Ngorongoro',
    description: 'After breakfast, travel to Ngorongoro and descend into the crater for a memorable game drive to see big 5 animals, lions, rhinos, elephants, wildebeest and more on the crater floor. At afternoon you enjoy a picnic lunch at the hippo pool site near you, then game driver continues and later visit the view of the crater at the top, and check out the park and drive back to lake Manyara area for overnight.',
    image: 'images/ngorongoro/pexels-lan-yao-324969-20847561.jpg',
  },
  {
    day: 5,
    title: 'LAKE Manyara',
    location: 'Lake Manyara',
    description: 'Pick up morning from your hotel and depart for Lake Manyara National Park with a picnic lunch for a full day game drive. As you enter the national park, lush forests of Acacia and Mahogany trees begin to set the mood for what is waiting ahead. The game drive will go on till afternoon with a small break for picnic lunch. During the game drive watch out for buffaloes, giraffes, impalas, baboons and the blue monkeys. Another spectacle of Lake Manyara National park is the tree climbing lions, however spotting them is a game of luck. In the right season, you can see the shoreline turning pink with millions of flamingos flocking there. Post the game drive, you will head back to Arusha.',
    image: 'images/lake-duluti/Lake-Duluti-1-scaled.jpg',
  },
];

const priceIncludes = [
  { label: 'All park entry fees', icon: 'M9 12l2 2 4-4m5.618-4.016A11.955 11.955 0 0112 2.944a11.955 11.955 0 01-8.618 3.04A12.02 12.02 0 003 9c0 5.591 3.824 10.29 9 11.622 5.176-1.332 9-6.03 9-11.622 0-1.042-.133-2.052-.382-3.016z' },
  { label: 'Private safari vehicle 4x4 Luxury', icon: 'M8 7h12m0 0l-4-4m4 4l-4 4m0 6H4m0 0l4 4m-4-4l4-4' },
  { label: 'Full-board accommodation lodges', icon: 'M3 12l2-2m0 0l7-7 7 7M5 10v10a1 1 0 001 1h3m10-11l2 2m-2-2v10a1 1 0 01-1 1h-3m-6 0a1 1 0 001-1v-4a1 1 0 011-1h2a1 1 0 011 1v4a1 1 0 001 1m-6 0h6' },
  { label: 'Daily meals (breakfast, lunch, dinner)', icon: 'M12 8v13m0-13V6a2 2 0 112 2h-2zm0 0V5.5A2.5 2.5 0 109.5 8H12zm-7 4h14M5 12a2 2 0 110-4h14a2 2 0 110 4M5 12v7a2 2 0 002 2h10a2 2 0 002-2v-7' },
  { label: 'Drinking water and soft drinks', icon: 'M19.428 15.428a2 2 0 00-1.022-.547l-2.387-.477a6 6 0 00-3.86.517l-.318.158a6 6 0 01-3.86.517L6.05 15.21a2 2 0 00-1.806.547M8 4h8l-1 1v5.172a2 2 0 00.586 1.414l5 5c1.26 1.26.367 3.414-1.415 3.414H4.828c-1.782 0-2.674-2.154-1.414-3.414l5-5A2 2 0 009 10.172V5L8 4z' },
  { label: 'Unlimited game drives', icon: 'M14 10l-2 1m0 0l-2-1m2 1v2.5M20 7l-2 1m2-1l-2-1m2 1v2.5M14 4l-2-1-2 1M4 7l2-1M4 7l2 1M4 7v2.5M12 21l-2-1m2 1l2-1m-2 1v-2.5M6 18l-2-1v-2.5M18 18l2-1v-2.5' },
  { label: 'Professional driver-guide', icon: 'M16 7a4 4 0 11-8 0 4 4 0 018 0zM12 14a7 7 0 00-7 7h14a7 7 0 00-7-7z' },
  { label: 'Airport transfers', icon: 'M12 19l9 2-9-18-9 18 9-2zm0 0v-8' },
  { label: 'Government VATS', icon: 'M9 14l6-6m-5.5.5h.01m4.99 5h.01M19 21V5a2 2 0 00-2-2H7a2 2 0 00-2 2v16l3.5-2 3.5 2 3.5-2 3.5 2z' },
];
</script>
